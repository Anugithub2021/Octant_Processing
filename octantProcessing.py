...
os.chdir(r'C:\Users\User\Documents\GitHub\Octant_Processing') # making the parent directory as current directory
...
def proj_octant_gui():
	...
	with st.container():
		...
		st.header("Made by Anuradha Das Group and Aman Jha :star2:")
		st.subheader("2001CB10 and 2001EE22")
		st.write('''
