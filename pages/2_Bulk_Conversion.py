...
def octant_processing(m,mod=5000):
	...
	try: # opening the input excel sheet
		os.chdir(r'C:\Users\Aman Jha\Documents\GitHub\Octant_Processing\input') # making the parent directory as input directory
...
input_path=st.text_input("Upload the path of the input files",placeholder=r"Please enter the path, for example:- 'C:\Users\User\Documents\GitHub\Octant_Processing\input' (without inverted commas)")
